...
namespace PractZadan_5
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var key2 = tripleDes.GenerateRandomNumber(16);
            var iv2 = tripleDes.GenerateRandomNumber(8);
            ...
            var key3 = aes.GenerateRandomNumber(32);
            var iv3 = aes.GenerateRandomNumber(16);
